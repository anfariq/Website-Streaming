...
// URL target
$url = "https://komikindo3.com/manhwa";
...
<body class="bg-gray-900 text-white">
    ...
    <div class="sticky top-0 z-50 bg-pink-600 text-white py-2 px-4 flex justify-between items-center">
        <span class="text-sm font-medium">Promote your brand! Contact us on <a href="https://www.instagram.com/fa2yl/" target="_blank" class="underline">Instagram</a>.</span>
    ...
    <nav class="bg-pink-700 py-3 px-4">
        <ol class="list-reset flex">
            <li><a href="#" class="text-white hover:text-pink-300">Home</a></li>
        </ol>
    </nav>

    <!-- Hero Section -->
    <div class="text-center py-12">
        <h1 class="text-4xl font-extrabold text-pink-400 mb-4">Explore the World of Comics</h1>
        <p class="text-gray-300">Discover the latest releases and immerse yourself in the best stories.</p>
    </div>

    <!-- Image Gallery 
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 px-4">
        <img src="https://via.placeholder.com/300" alt="Comic Image 1" class="rounded-lg shadow-lg hover:scale-105 transform transition">
        <img src="https://via.placeholder.com/300" alt="Comic Image 2" class="rounded-lg shadow-lg hover:scale-105 transform transition">
        <img src="https://via.placeholder.com/300" alt="Comic Image 3" class="rounded-lg shadow-lg hover:scale-105 transform transition">
        <img src="https://via.placeholder.com/300" alt="Comic Image 4" class="rounded-lg shadow-lg hover:scale-105 transform transition">
    </div> -->
